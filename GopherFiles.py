# $Id: GopherFiles.py,v 1.15 2001/08/29 14:29:42 jgoerzen Exp $
...
class GopherFileDir(GopherFile, UserList):
    ...
    def display(self):
        ...
        print "</TITLE></HEAD><BODY><H1>Gopher: "
        print cgi.escape(self.getusername())
        print '</H1>'
        ...
        print "</TABLE><HR>"
        print '<FONT SIZE="-1">[<A HREF="' + self.getHTMLlink(about=1) + \
              '">about</A>]&nbsp;[<A HREF="' + self.getgopherURL() + \
              '">native&nbsp;view</A>]&nbsp;' + \
              '[<A HREF="hurg?cmd=open">open</A>]</FONT><BR>'
